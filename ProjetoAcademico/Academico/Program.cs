...
do
{
    ...
    switch (opcao)
    {
        ...
        Aluno aluno = new Aluno();
            ...
            aluno.LocalNascimento = localNascimentoAluno;
            aluno.DataNascimento = dataNascimentoAluno;
            aluno.Nota1 = (double)nota1Aluno;
            aluno.Nota2 = (double)nota2Aluno;
            aluno.Nota3 = (double)nota3Aluno;
        ...
        case 2:
            foreach(Aluno individuo in alunos){
